...
public class Runner {
	...
	private Collection<GameCharacterable> characters = new ArrayList<GameCharacterable>(); // All enemies in the game
	private Collection<Location> locations = new ArrayList<Location>();// All locations in the game
